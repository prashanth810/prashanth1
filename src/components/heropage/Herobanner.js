...
const Herobanner = () => {
    ...
    return (
        <section className='px-4 py-14 fade-in'>
            <div className='md:grid md:grid-cols-2 grid-cols-1 items-center justify-center md:w-[85%] lg:mx-auto md:mx-auto mt-16 flex flex-col-reverse'>
                <div>
                    <div className="py-5">
                ...
                <div className='flex justify-center cursor-pointer'>
                    <img
                        src={heroimg}
                        className='md:w-[60%] w-[70%] md:mx-0 mx-auto rounded'
                    />
                </div>
